...
export const schema = {
  ...
  lagoon: {
    ...
    fields: {
      ...
      x: { type: 'float', label: 'East/west', min: -0.55, max: 0.55, step: 0.01, default: -0.32, hint: 'lagoon center as island-radius fraction' },
      z: { type: 'float', label: 'North/south', min: -0.55, max: 0.55, step: 0.01, default: 0.16, hint: 'lagoon center as island-radius fraction' },
      radiusX: { type: 'float', label: 'Long radius', min: 40, max: 420, step: 5, default: 260, unit: 'm', hint: 'major axis of the lagoon bowl' },
      ...
      depth: { type: 'float', label: 'Depth', min: 0.05, max: 8, step: 0.05, default: 0.30, unit: 'm', hint: 'floor below sea datum at the center' },
      ...
      apronWidth: { type: 'float', label: 'Apron width', min: 4, max: 120, step: 2, default: 72, unit: 'm', hint: 'white-sand / grass transition around lagoon' },
      whiteSand: { type: 'float', label: 'White sand', min: 0, max: 1, step: 0.02, default: 1, hint: 'strength of lagoon white-sand material' },
  ...
  water: {
    ...
    fields: {
      ...
      lagoonTint: { type: 'float', label: 'Lagoon tint', min: 0, max: 2, step: 0.02, default: 0.85, hint: 'extra cyan along generated lagoon/channel water' },
    },
  },
  ...
  tree: {
    ...
    fields: {
      ...
      autumnWeight: { type: 'float', label: 'Autumn weight', min: 0, max: 3, step: 0.05, default: 1.7, hint: 'overweights autumn trees beyond raw terrain percent' },
