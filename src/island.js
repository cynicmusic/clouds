...
function makeWorkshopSchema() {
  ...
  out.cloudShadows = {
    ...
    fields: {
      ...
      temporalSmoothing: { type: 'float', label: 'History', min: 0, max: 0.999, step: 0.001, precision: 3, default: 0.99, hint: 'temporal history amount; higher = smoother, lower = faster response' },
      ...
      temporalJitter: { type: 'bool', label: 'Jitter', default: true, hint: 'structured temporal sampling in the Beer shadow march' },
